...
Assignment 4 primary documentation is in the root `README.md`.
...
- `appointment-service/README.md` — appointment-service details.
- `notification-service/README.md` — notification queue details.
- `mock-gateway/README.md` — external API simulation details.
